      ...
      <div>
              ...
              <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div class="flex mb-4">
                  <span class="flex items-center">
                    IR: {processorData?.indivisualrating}
                    <span class="text-gray-600 ml-3">
                      AR: {processorData?.averagerating}
                    </span>
                  </span>
                ...
                <p class="leading-relaxed">{processorData?.description}</p>
                <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                  <div class="flex">
                    <span class="mr-3">keyfeatures:</span>
                    <p class="ml-1 text-black w-6 h-6">
                      {processorData?.keyfeatures}
                    </p>
                  </div>
                </div>
                <div class="flex">
        ...
        <section class="text-gray-600 body-font">
          <div class="container px-5 py-8 mx-auto">
            {processorData?.reviews.map((review, index) => (
              <div
                key={index}
...
export const getStaticProps = async (context) => {
  ...
  const res = await fetch(
    `https://pc-builder-backend-server.onrender.com/categories/processor/${params.processorid}`,
  );
