              ...
              <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div class="flex mb-4">
                  <span class="flex items-center">
                    IR: {ramData?.indivisualrating}
                    <span class="text-gray-600 ml-3">
                      AR: {ramData?.averagerating}
                    </span>
                  </span>
                ...
                <p class="leading-relaxed">{ramData?.description}</p>
...
export const getStaticProps = async (context) => {
  ...
  const res = await fetch(
    `https://pc-builder-backend-server.onrender.com/categories/ram/${params.ramid}`,
  );
